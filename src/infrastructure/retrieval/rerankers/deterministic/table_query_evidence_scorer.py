...
def table_query_evidence_score(
    *,
    ...
    has_direct_table_evidence_value = has_direct_table_evidence(chunk)
    ...
    if has_direct_table_evidence_value:
        score += 10.0
    ...
    if _has_any_marker(query_text, TABLE_REQUEST_MARKERS):
        score += 4.0 if has_direct_table_evidence_value else -4.0
    ...
    if (
        ...
        and has_direct_table_evidence_value
    ):
        score += 4.0
