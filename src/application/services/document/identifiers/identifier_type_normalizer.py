...
_NORMALIZED_TYPE_ALIASES: dict[str, IdentifierType] = {
    ...
    "productname": IdentifierType.PRODUCT_NAME,
    "producttitle": IdentifierType.PRODUCT_NAME,
    "equipmentname": IdentifierType.PRODUCT_NAME,
    "systemname": IdentifierType.PRODUCT_NAME,
