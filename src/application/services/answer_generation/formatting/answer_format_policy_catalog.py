...
def build_policy_catalog(
    policy_cls: "type[AnswerFormatPolicy]",
) -> "dict[AnswerIntent, AnswerFormatPolicy]":
    """Build the static AnswerIntent -> AnswerFormatPolicy catalog.

    Takes the AnswerFormatPolicy class as a parameter, rather than importing
    it directly, because answer_format_policy.py imports this module's
    catalog -- importing the class here too would create a circular import.
    """
    return {
        AnswerIntent.SPECIFICATION_SUMMARY: policy_cls(
        ...
        AnswerIntent.MAINTENANCE_SUMMARY: policy_cls(
        ...
        AnswerIntent.PROCEDURE_STEPS: policy_cls(
        ...
        AnswerIntent.SAFETY_WARNINGS: policy_cls(
        ...
        AnswerIntent.TROUBLESHOOTING: policy_cls(
        ...
        AnswerIntent.CERTIFICATION_SUMMARY: policy_cls(
        ...
        AnswerIntent.IDENTIFIER_LOOKUP: policy_cls(
        ...
        AnswerIntent.TABLE_SUMMARY: policy_cls(
        ...
        AnswerIntent.DOCUMENT_SUMMARY: policy_cls(
        ...
        AnswerIntent.GENERAL: policy_cls(
