...
class ListSectionsRequest(ToolRequest):
...
class ListSectionsTool:
    metadata = ToolMetadata(
        ...
        description="List the section hierarchy for a document.",
        mutates_state=False,
    )
    ...
    def run(self, request: ListSectionsRequest) -> ToolResult:
        ...
        return ToolResult.ok(data=result.sections, metadata=self.metadata)
