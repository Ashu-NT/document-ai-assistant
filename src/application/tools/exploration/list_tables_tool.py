...
class ListTablesRequest(ToolRequest):
...
class ListTablesTool:
    metadata = ToolMetadata(
        ...
        description="List tables for a document without retrieving by query.",
        mutates_state=False,
    )
    ...
    def run(self, request: ListTablesRequest) -> ToolResult:
