...
from src.domain.extraction import EquipmentInfo, TroubleshootingEntry
from src.shared.ids import IdGenerator


class TroubleshootingEntryBuilder:
    def __init__(
        self,
    ...
    def build(
        ...
        *,
        ...
        equipment_reference = support.optional_text(
            payload, "equipment_reference", "equipment_name", "equipment"
        )
        equipment_id = resolve_equipment_id(equipment_reference, equipment)

        return TroubleshootingEntry(
            troubleshooting_id=self._id_generator.new_id("troubleshooting"),
            document_id=document_id,
            symptom=symptom,
            cause=support.optional_text(payload, "cause"),
            remedy=support.optional_text(payload, "remedy"),
