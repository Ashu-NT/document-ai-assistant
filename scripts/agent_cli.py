...
def build_agent_runtime(
    ...
    *,
    ...
    from src.application.agent_runtime import build_agent_runtime as _build_agent_runtime
...
def close_runtime(runtime: AgentRuntime | None) -> None:
    from src.application.agent_runtime import close_agent_runtime

    close_agent_runtime(runtime)
