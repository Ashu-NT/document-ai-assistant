    ...
    raw_document = FakeRawDocument(
        [
            FakeDoclingItem(
                ...
                text="Overview text.",
                self_ref="#/texts/1",
                prov=[FakeProvenance(1, FakeBBox(40, 1220, 420, 1300))],
            ),
            FakeDoclingItem(
                label="text",
                text="Left column detail.",
                self_ref="#/texts/3",
                prov=[FakeProvenance(1, FakeBBox(55, 1100, 430, 1180))],
            ),
            FakeDoclingItem(
                label="text",
                text="Second column text.",
                self_ref="#/texts/2",
                prov=[FakeProvenance(1, FakeBBox(560, 1210, 940, 1290))],
            ),
            FakeDoclingItem(
                label="text",
                text="Right column detail.",
                self_ref="#/texts/4",
                prov=[FakeProvenance(1, FakeBBox(575, 1090, 950, 1170))],
            ),
        ],
        pages={
